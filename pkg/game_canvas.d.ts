/* tslint:disable */
/* eslint-disable */
export function set_image(name: string, sheet: boolean, img?: HTMLImageElement | null): void;
export function get_and_give_f64(num?: number | null): void;
